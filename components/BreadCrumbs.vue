      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li v-for="path, pk in props.breadcrumbs" :key="path.id">
          <div class="flex items-center">
            ...
            <p v-if="pk === props.breadcrumbs.length - 1" class="ml-1 text-xs text-center font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-300 dark:hover:text-gray-100">{{ path.name }}</p>
