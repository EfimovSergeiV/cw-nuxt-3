  ...
  <div>
    ...
    <div class="mx-auto px-4 my-2 max-w-6xl lg:px-8">
      <div class="grid grid-cols-1 md:flex items-center justify-between">
        ...
        <div class="flex flex-wrap gap-1 items-center md:justify-end my-2">
          <button class=" px-2 md:px-4 h-6 md:h-8 text-xs md:text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" @click="notificationsStore.statusFilterComponent">Фильтр</button>
          <nuxt-link :to="{ name: 'prods', query: { page: 1, ...route.query, by: 'Date' } }" class=" px-2 md:px-4 h-6 md:h-8 text-xs md:text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Новые</nuxt-link>
          ...
          <nuxt-link :to="{ name: 'prods', query: { page: 1, ...route.query, by: 'LowPrice' } }" class=" px-2 md:px-4 h-6 md:h-8 text-xs md:text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Дешевле</nuxt-link>
          <nuxt-link :to="{ name: 'prods', query: { page: 1, ...route.query, by: 'HighPrice' } }" class=" px-2 md:px-4 h-6 md:h-8 text-xs md:text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Дороже</nuxt-link>
        </div>
