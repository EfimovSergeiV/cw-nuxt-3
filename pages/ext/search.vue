<script setup>
  ...
  useSeoMeta({
    title: `Поиск по товарам в наличии в магазинах`,
    description: `Сварочное оборудование, оборудование для сварки, купить электроды, купить проволоку, купить источник, купить сварочный инвертор`,
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li class="">
            <div class="flex items-center">
              ...
              <p class="ml-1 text-xs text-center font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-300 dark:hover:text-gray-100">Расширенный поиск</p>
            </div>
          </li>
        </ol>
      </nav>
